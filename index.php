...
<body>
    ...
    <div class="contener">
           ...
           <li class="nav-item dropdown">
             ...
             <!-- Lo que sigue son los menus que se van a desplegar hacia abajo, cada uno tendra el nombre de su practica, ejemplo, practica uno se llamara su nombre el numero de la practica ZZ terminando con HTML -->
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
               ...
               <a class="dropdown-item" href="/reyesmezabrunoeduardo/Bruno6.php">Practica 6</a><br>
              </div>
           </li>
           <li class="nav-item dropdown">
             <a class="nav-link dropdown-toggle" href="" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       ...
       <div class="jumbotron">
        <h1 class="display-4" style="text-align:center;">¿Quieres al bebeton en tu celular?
        </h1>
        <p class="lead" style="text-align:center;">Marca al 8999391024</p>
        <hr class="my-4">
        <p style="text-align:center;">Dj Dante</p>
      </div>
